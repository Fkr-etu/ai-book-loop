...
Le délai est un heuristique UX : il ne prétend pas détecter sémantiquement un blocage. Il sert de signal léger au moment où l’auteur semble hésiter.
...
Le frontend ne pré-génère aucune question et n’appelle le LLM qu’après l’action explicite de l’auteur. Les garde-fous de coût restent côté backend : modèle dédié, historique borné et maximum de 8 tours.
