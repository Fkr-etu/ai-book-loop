...
const queuedJob = { job_id: "job-async-e2e", book_id: bookId, analysis_type: "consistency", status: "queued", progress: 0, current_step: null, attempt: 0, created_at: "2026-09-10T10:00:00Z", started_at: null, completed_at: null, failed_at: null, error_code: null, error_message: null, result: null };
const runningJob = { ...queuedJob, status: "running", progress: 35, current_step: "analyzing", attempt: 1, started_at: "2026-09-10T10:00:01Z" };
