...
export default function PrivacyPage() {
  return (
    <LegalPage title="Politique de confidentialité" description="Base de publication pour l'information des utilisateurs sur les données personnelles traitées par Book Loop.">
      <section><h2 className="font-playfair text-2xl font-bold">Responsable du traitement</h2><p className="mt-4"><Placeholder>{legal.operator.name}</Placeholder> · <Placeholder>{legal.operator.contact}</Placeholder></p></section>
