...
export const metadata: Metadata = {
  ...
  description: "Méthode pour détecter et corriger les contradictions d’un roman : personnages, chronologie, lieux, relations et règles du monde.",
  alternates: { canonical: "/guides/eviter-contradictions-roman" },
};
