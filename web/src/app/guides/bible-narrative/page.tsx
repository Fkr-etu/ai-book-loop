...
export const metadata: Metadata = {
  ...
  description: "Définition et méthode pour comprendre une bible narrative, ses éléments essentiels et son rôle dans une histoire longue.",
  alternates: { canonical: "/guides/bible-narrative" },
};
