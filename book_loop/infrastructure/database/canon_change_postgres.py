...
from book_loop.infrastructure.database.canonical_fact_embeddings import CanonicalFactEmbeddingRepositoryMixin
from book_loop.infrastructure.database.postgres import PostgresBookRepository


class PostgresCanonChangeRepository(
    CanonChangeRepositoryMixin,
    CanonicalFactEmbeddingRepositoryMixin,
    PostgresBookRepository,
):
    """PostgreSQL repository with Canon change and embedding persistence."""
