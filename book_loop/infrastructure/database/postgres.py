...
class _PostgresConnectionAdapter:
    """Small DB-API compatibility layer for the existing repository SQL."""
...
class PostgresBookRepository(SQLiteBookRepository):
    """PostgreSQL implementation sharing the Book repository contract."""
